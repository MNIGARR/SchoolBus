...
using INavigationService = SchoolBus.Presentation.Services.INavigationService;
using NavigationService = SchoolBus.Presentation.Services.NavigationService;
...
namespace SchoolBus.Presentation
{
    ...
    public partial class App : Application
    {
        ...
        private void Register()
        {
            ...
            Container.RegisterSingleton<MainVindow>();

            Container.RegisterSingleton<CarView>();

            Container.RegisterSingleton<ClassView>();

            Container.RegisterSingleton<DriverView>();

            Container.RegisterSingleton<ParentView>();

            Container.RegisterSingleton<RideView>();
